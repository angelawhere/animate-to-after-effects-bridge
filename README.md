...
**Script runs from inside a symbol** – always export from the main timeline. The script exits any open symbol edit modes automatically, but it's good practice to return to the main timeline before running.
